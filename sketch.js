...
function checkForBlueUpsAndDowns(){
  ...
  if(blueSpaces === 2){
    Matter.Body.setVelocity(bluePawn.body,{x : 8, y : -14})
    blueSpaces = 23;
  }
  if(blueSpaces === 6){
  ...
  if(blueSpaces === 71){
    Matter.Body.setVelocity(bluePawn.body,{x : -6, y : -11})
    blueSpaces = 92;
  }
  ...
  if(blueSpaces === 98){
    Matter.Body.setVelocity(bluePawn.body,{x : -15, y : 41})
    blueSpaces = 40;
  }
  if(blueSpaces === 87){
    Matter.Body.setVelocity(bluePawn.body,{x : 12.85, y : 28})
    blueSpaces = 49;
  }
  if(blueSpaces === 84){
    Matter.Body.setVelocity(bluePawn.body,{x : -7, y : 21})
    blueSpaces = 58;
  }
  if(blueSpaces === 73){
    Matter.Body.setVelocity(bluePawn.body,{x : -13, y : 40})
    blueSpaces = 15;
  }
  if(blueSpaces === 56){
    Matter.Body.setVelocity(bluePawn.body,{x : 20, y : 34})
    blueSpaces = 8;
  }
  if(blueSpaces === 50){
    Matter.Body.setVelocity(bluePawn.body,{x : -35, y : 27})
    blueSpaces = 5;
  }
  if(blueSpaces === 43){
    Matter.Body.setVelocity(bluePawn.body,{x : 7.25, y : 19})
    blueSpaces = 17;
  }
